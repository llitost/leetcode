...
public class StringToIntegerAtoi {
    ...
    class Automaton {
        ...
        {
            stateMap.put("start", new String[]{"start", "signed", "in_number", "end"});
            stateMap.put("signed", new String[]{"end", "end", "in_number", "end"});
            stateMap.put("in_number", new String[]{"end", "end", "in_number", "end"});
        ...
        public void get(char c) {
            ...
            if ("in_number".equals(state)) {
                ans = ans * 10 + sign * (c - '0');
                ans = sign == 1 ? Math.min(Integer.MAX_VALUE, ans) : Math.max(Integer.MIN_VALUE, ans);
